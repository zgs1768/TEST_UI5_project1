		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#packageproject1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"packageproject1-display": {
								"semanticObject": "packageproject1",
								"action": "display",
								"description": "应用描述",
								"title": "App Title",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=package.project1",
									"url": sap.ui.require.toUrl("package/project1")
								}
							}
						}
					}
